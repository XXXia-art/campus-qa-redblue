...
$cmd = "mitmweb --web-host 127.0.0.1 --web-port $WebPort --listen-host 0.0.0.0 --listen-port $ListenPort --showhost --scripts `"$script`""
...
Write-Host "Web UI: http://127.0.0.1:$WebPort" -ForegroundColor Yellow
Write-Host ""
